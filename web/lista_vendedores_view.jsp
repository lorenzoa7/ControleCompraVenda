...
<body>
    ...
    <div class="container">
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <%
                                ArrayList<Funcionario> ListaVendedores = (ArrayList<Funcionario>) request.getAttribute("meusVendedores");
                                for (int i = 0; i < ListaVendedores.size(); i++) {
                                    Funcionario aux = ListaVendedores.get(i);
                                    String link_editar = "FuncionarioController?acao=editar&id="+aux.getId()+"&papel="+aux.getPapel();
                                    String link_excluir = "FuncionarioController?acao=excluir_vendedor&id="+aux.getId();
                            %>
                            <tr>
                                <td><%=aux.getId()%></td>
                                <td><%=aux.getNome()%></td> 
        ...
        <div class="justify-content-center align-items-center row">
            <a href="FuncionarioController?acao=cadastrar_vendedor" class="btn w-25 btn-warning">Cadastrar novo vendedor</a>
        </div>
    </div>
